# BmiCalculator Python SDK Reference

Complete API reference for the BmiCalculator Python SDK.
...
#### `BmiCalculatorSDK.test(testopts=None, sdkopts=None)`
...
Create a new `BmiEntity` instance. Pass `None` for no initial data.
...
| --- | --- | --- | --- |
| `Category` | `str` | Yes | Health category based on BMI |
...
Create a new `BmiEntity` instance with the same options.
