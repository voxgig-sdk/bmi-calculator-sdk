...
from bmicalculator_sdk.utility import register

# Load features
from bmicalculator_sdk.feature.base_feature import BmiCalculatorBaseFeature
from bmicalculator_sdk.features import _has_feature, _make_feature
...
class BmiCalculatorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BmiCalculatorUtility()
        self._utility = utility

        from bmicalculator_sdk.config import shared_config
    ...
    def get_utility(self):
        return BmiCalculatorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BmiCalculatorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Bmi(self, data=None) -> "BmiEntity":
        ...
        from bmicalculator_sdk.entity.bmi_entity import BmiEntity
