...
from bmicalculator_sdk.core.control import BmiCalculatorControl
...
from bmicalculator_sdk.core.helpers import get_ctx_prop, to_map
...
class BmiCalculatorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BmiCalculatorControl()
        ...
        if isinstance(sp, BmiCalculatorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BmiCalculatorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BmiCalculatorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BmiCalculatorError(code, msg, self)
