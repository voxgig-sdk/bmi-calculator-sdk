# BmiCalculator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BmiCalculatorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BmiCalculatorSDK(...) and BmiCalculatorSDK.test(...) become
#      BmiCalculatorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bmicalculator_sdk"
_SDK_CLASS = "BmiCalculatorSDK"
