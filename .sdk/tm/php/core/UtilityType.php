...
// BmiCalculator SDK utility type

class BmiCalculatorUtility
{
    ...
    public static function copy(BmiCalculatorUtility $src): BmiCalculatorUtility
    {
        $u = new BmiCalculatorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
