...
// BmiCalculator SDK streaming feature
...
class BmiCalculatorStreamingFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _iterate(BmiCalculatorResult $result): \Generator
    {
    ...
    private function _streamable(BmiCalculatorContext $ctx): bool
    {
