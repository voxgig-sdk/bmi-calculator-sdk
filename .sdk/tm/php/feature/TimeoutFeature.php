...
// BmiCalculator SDK timeout feature
...
class BmiCalculatorTimeoutFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _with_timeout(BmiCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BmiCalculatorContext $_ctx, float $ms): void
    {
        $client = $this->client;
