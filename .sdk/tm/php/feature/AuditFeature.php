...
// BmiCalculator SDK audit feature
...
class BmiCalculatorAuditFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _emit(BmiCalculatorContext $ctx, string $outcome): void
    {
