...
// BmiCalculator SDK rbac feature
...
class BmiCalculatorRbacFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _required(BmiCalculatorContext $ctx): ?string
    {
    ...
    private function _reject(BmiCalculatorContext $ctx, string $required): void
    {
    ...
    private function _track(BmiCalculatorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
