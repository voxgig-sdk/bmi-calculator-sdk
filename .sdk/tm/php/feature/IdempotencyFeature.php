...
// BmiCalculator SDK idempotency feature
...
class BmiCalculatorIdempotencyFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _mutating(BmiCalculatorContext $ctx): bool
    {
