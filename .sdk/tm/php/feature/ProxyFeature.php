...
// BmiCalculator SDK proxy feature
...
class BmiCalculatorProxyFeature extends BmiCalculatorBaseFeature
{
    ...
    public function init(BmiCalculatorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BmiCalculatorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
