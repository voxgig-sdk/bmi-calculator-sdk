...
// BmiCalculator SDK netsim feature
...
class BmiCalculatorNetsimFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _simulate(BmiCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BmiCalculatorContext $ctx, array $applied): void
    {
        $client = $this->client;
