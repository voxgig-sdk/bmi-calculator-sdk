...
// BmiCalculator SDK ratelimit feature
...
class BmiCalculatorRatelimitFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _acquire(BmiCalculatorContext $ctx): void
    {
    ...
    private function _track(BmiCalculatorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
