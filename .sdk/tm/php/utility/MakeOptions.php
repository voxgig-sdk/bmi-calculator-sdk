...
// BmiCalculator SDK utility: make_options

class BmiCalculatorMakeOptions
{
    ...
    public static function call(BmiCalculatorContext $ctx): array
    {
        ...
        //
        // `BmiCalculatorSchema::optspec()` is built from the model:
        ...
        $optspec = BmiCalculatorSchema::optspec();
