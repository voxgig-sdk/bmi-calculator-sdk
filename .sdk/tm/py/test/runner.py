...
class BmiCalculatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BmiCalculatorTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = BmiCalculatorTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = BmiCalculatorTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
