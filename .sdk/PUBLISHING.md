...
|---|---|---|
| `ts/` | @voxgig-sdk/bmi-calculator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/bmi-calculator-sdk \
      --repository voxgig-sdk/bmi-calculator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/bmi-calculator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/bmi-calculator-sdk --id=<id>` removes it.
