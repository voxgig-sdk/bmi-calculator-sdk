...
type BmiEntity struct {
	name    string
	client  *core.BmiCalculatorSDK
...
func NewBmiEntity(client *core.BmiCalculatorSDK, entopts map[string]any) *BmiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BmiEntity) GetName() string { return e.name }
...
func (e *BmiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BmiEntity) Deleted() bool {
	return e.deleted
}


func (e *BmiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBmiEntity(e.client, opts)
}

func (e *BmiEntity) Data(args ...any) any {
...
func (e *BmiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Bmi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BmiEntity) DataTyped(data ...Bmi) Bmi {
	if len(data) > 0 {
		return typedFrom[Bmi](e.Data(asMap(data[0])))
	}
	return typedFrom[Bmi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Bmi (all fields
// optional at the wire level).
func (e *BmiEntity) MatchTyped(match ...Bmi) Bmi {
	if len(match) > 0 {
		return typedFrom[Bmi](e.Match(asMap(match[0])))
	}
	return typedFrom[Bmi](e.Match())
}
...
func (e *BmiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BmiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BmiLoadMatch and returns an Bmi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BmiEntity) LoadTyped(reqmatch BmiLoadMatch, ctrl map[string]any) (Bmi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Bmi{}, err
	}
	return typedFrom[Bmi](res), nil
}



func (e *BmiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BmiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BmiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BmiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BmiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
