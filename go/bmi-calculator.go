...
import (
	...
	"github.com/voxgig-sdk/bmi-calculator-sdk/go/entity"
	"github.com/voxgig-sdk/bmi-calculator-sdk/go/feature"
	_ "github.com/voxgig-sdk/bmi-calculator-sdk/go/utility"
)
...
// instead of `sdk.NewBmiCalculatorSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *BmiCalculatorSDK  { return NewBmiCalculatorSDK(nil) }
func Test() *BmiCalculatorSDK { return TestSDK(nil, nil) }
