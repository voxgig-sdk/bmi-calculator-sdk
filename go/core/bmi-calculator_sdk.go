...
func (sdk *BmiCalculatorSDK) OptionsMap() map[string]any {
...
func (sdk *BmiCalculatorSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BmiCalculatorSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BmiCalculatorSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BmiCalculatorSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BmiCalculatorSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BmiCalculatorSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BmiCalculatorSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BmiCalculatorSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BmiCalculatorSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BmiCalculatorSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *BmiCalculatorSDK {
	...
	sdk := NewBmiCalculatorSDK(sdkopts)
	sdk.Mode = "test"
