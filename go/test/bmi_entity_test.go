...
func TestBmiEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set BMI_CALCULATOR_TEST_BMI_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func bmiBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BMI_CALCULATOR_TEST_BMI_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BMI_CALCULATOR_TEST_BMI_ENTID"])
