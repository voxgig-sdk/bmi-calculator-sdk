...
(0, node_test_1.describe)('BmiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BmiCalculatorSDK({
    ...
    (0, node_test_1.test)('direct-load-bmi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-bmi', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BMI_CALCULATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BmiCalculatorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['BMI_CALCULATOR_TEST_BMI_ENTID'];
    ...
    const client = new __1.BmiCalculatorSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BmiDirect.test.js.map