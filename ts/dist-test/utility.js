...
function envOverride(m) {
    if ('TRUE' === process.env.BMI_CALCULATOR_TEST_LIVE ||
        'TRUE' === process.env.BMI_CALCULATOR_TEST_OVERRIDE) {
    ...
    m.BMI_CALCULATOR_TEST_EXPLAIN = process.env.BMI_CALCULATOR_TEST_EXPLAIN || m.BMI_CALCULATOR_TEST_EXPLAIN;
    return m;
}
