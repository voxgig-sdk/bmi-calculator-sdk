...
type Args struct {
	Entity string         `json:"entity" jsonschema:"bmi"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BmiCalculatorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bmi-calculator_list",
		Description: "List records from BmiCalculator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bmi-calculator_load",
		Description: "Load a single record from BmiCalculator. " +
...
func runOp(client *sdk.BmiCalculatorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BmiCalculatorSDK, name string) (sdk.BmiCalculatorEntity, error) {
	switch strings.ToLower(name) {
	case "bmi":
		return client.Bmi(nil), nil
