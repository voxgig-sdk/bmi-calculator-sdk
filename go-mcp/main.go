// Command BmiCalculator-mcp is an MCP server exposing the BmiCalculator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BmiCalculator_list  — list records of an entity
//	BmiCalculator_load  — load a single record of an entity
//
