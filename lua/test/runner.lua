...
function runner.env_override(m)
  local live = runner.getenv("BMICALCULATOR_TEST_LIVE")
  local override = runner.getenv("BMICALCULATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BMICALCULATOR_TEST_EXPLAIN")
