...
function runner.env_override(m)
  local live = runner.getenv("BMI_CALCULATOR_TEST_LIVE")
  local override = runner.getenv("BMI_CALCULATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BMI_CALCULATOR_TEST_EXPLAIN")
