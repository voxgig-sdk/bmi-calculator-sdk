...
describe("BmiDirect", function()
  it("should direct-load-bmi", function()
    local setup = bmi_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-bmi", setup.live and "live" or "unit")
...
function bmi_direct_setup(mockres)
