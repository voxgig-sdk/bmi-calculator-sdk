...
// BmiCalculator SDK clienttrack feature
...
class BmiCalculatorClienttrackFeature extends BmiCalculatorBaseFeature
{
    ...
    public function PostConstruct(BmiCalculatorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BmiCalculator-SDK';
