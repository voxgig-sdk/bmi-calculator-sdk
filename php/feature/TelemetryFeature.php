...
// BmiCalculator SDK telemetry feature
...
class BmiCalculatorTelemetryFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _close(BmiCalculatorContext $ctx, bool $ok): void
    {
