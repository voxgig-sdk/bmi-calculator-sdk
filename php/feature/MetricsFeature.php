...
// BmiCalculator SDK metrics feature
...
class BmiCalculatorMetricsFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _record(BmiCalculatorContext $ctx, bool $ok): void
    {
