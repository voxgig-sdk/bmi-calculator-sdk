...
// BmiCalculator SDK cache feature
...
class BmiCalculatorCacheFeature extends BmiCalculatorBaseFeature
{
    ...
    private function _through(BmiCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
