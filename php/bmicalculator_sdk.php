...
class BmiCalculatorSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = BmiCalculatorHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = BmiCalculatorHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!BmiCalculatorFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, BmiCalculatorFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return BmiCalculatorUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = BmiCalculatorHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = BmiCalculatorHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = BmiCalculatorHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new BmiCalculatorError($op . "_allow",
                "BmiCalculatorSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = BmiCalculatorHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new BmiCalculatorError("graphql_error",
                "BmiCalculatorSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Bmi($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_bmi === null) {
                $this->_bmi = new BmiEntity($this, null);
            }
            return $this->_bmi;
        }
        return new BmiEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new BmiCalculatorSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
