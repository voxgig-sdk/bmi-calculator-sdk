...
// BmiCalculator SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BmiCalculatorOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BmiCalculatorOmni::structfix($now, Struct::undef()))
                        !== json_encode(BmiCalculatorOmni::structfix($val, Struct::undef()))) {
