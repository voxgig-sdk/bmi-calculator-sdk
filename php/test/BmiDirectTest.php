...
class BmiDirectTest extends TestCase
{
    public function test_direct_load_bmi(): void
    {
        $setup = bmi_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-bmi", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
