...
// BmiCalculator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BmiCalculatorSDK::test)
...
{
    private const SDK_CLASS = 'BmiCalculatorSDK';
    ...
    private const SDK_BASE = 'bmicalculator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bmicalculator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
