...
// BmiCalculator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BmiCalculatorMakeRequest
{
    public static function call(BmiCalculatorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BmiCalculatorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BmiCalculatorResponse($fetched);
        } else {
