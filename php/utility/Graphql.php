...
// BmiCalculator SDK utility: graphql
//
...
class BmiCalculatorGraphql
{
    ...
    // equivalent.
    public static function body(BmiCalculatorContext $ctx): mixed
    {
    ...
    public static function errors(BmiCalculatorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
