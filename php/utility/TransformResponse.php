...
// BmiCalculator SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BmiCalculatorTransformResponse
{
    public static function call(BmiCalculatorContext $ctx): mixed
    {
        ...
        $transform = BmiCalculatorHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
