...
// BmiCalculator SDK utility: fetcher

class BmiCalculatorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BmiCalculatorSDK/1.0)';
    ...
    public static function call(BmiCalculatorContext $ctx, string $fullurl, array $fetchdef): array
    {
