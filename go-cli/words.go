...
func registerSDKWords(r *eng.Registry, client *sdk.BmiCalculatorSDK) {
...
func runOp(client *sdk.BmiCalculatorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
