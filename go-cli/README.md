...
AQL-driven CLI and REPL for the BmiCalculator SDK. Positional arguments are
...
./bmi-calculator-cli list bmi
./bmi-calculator-cli load 1 bmi
./bmi-calculator-cli load '{id:1}' bmi
